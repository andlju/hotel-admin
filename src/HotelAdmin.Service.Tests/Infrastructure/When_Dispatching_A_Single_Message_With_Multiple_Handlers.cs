...
{
    [TestClass]
    public class When_Dispatching_A_Single_Message_With_Multiple_Handlers_NonGenerically : With_Dispatcher
    {
        ...
        {
            dispatcher.DispatchNonGeneric(new SimpleTestMessage() { TestString = "Test" });
        }
