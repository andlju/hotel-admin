...
{
    [TestClass]
    public class When_Getting_The_ModelId_Of_A_Mapped_Identity : With_Repository<IdentityMap, IIdentityMapRepository>
    {
        ...
        {
            _returnedId = _identityMapper.GetModelId<TestDomain>(_aggregateId);
        }

        [TestMethod]
        public void Then_Returned_Id_Is_Correct()
        {
            Assert.AreEqual(_modelId, _returnedId);
        }
    }
}